...
const NirvanaReportSchema = new Schema(
   {
      userClerkId: {
         type: String,
         required: true,
...
export const Report = model('NirvanaReport', NirvanaReportSchema);

export type Report = InferSchemaType<typeof NirvanaReportSchema>;
